...
type Step2Props = {
  ...
  setData: (field: keyof Step2Props['data'], value: string) => void;
  errors: Partial<Record<keyof Step2Props['data'], string>>;
  prevStep: () => void;
  handleSave: () => void;
  handleSubmit: () => void;
...
export default function Step2({data, setData, errors, prevStep, handleSave, handleSubmit, scoreOption}: Step2Props) {
  return (
    <>
