                                        ...
                                        <div className="flex flex-col">
                                            <div className="p-2 w-full">
                                                <div className="relative">
                                                    ...
                                                    <p className="rounded-md border-gray-300 shadow-sm mt-1 block w-full bg-gray-100 bg-opacity-50 border text-base text-gray-700 py-1 px-3 leading-8">{user.name}</p>
                                                </div>
                                            </div>
                                            ...
                                            <div className="p-2 w-full">
                                                <div className="relative">
                                                    <div className="relative">
                                                        ...
                                                        <p className="rounded-md border-gray-300 shadow-sm mt-1 block w-full bg-gray-100 bg-opacity-50 border text-base text-gray-700 py-1 px-3 leading-8">{user.kana}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="p-2 w-full flex gap-4 justify-center">
                                                ...
                                                {auth.permissions.adminUser ? <Link as="button" href={route('user.users.edit', {user: user.id})} className="text-white bg-indigo-500 border-0 py-2 px-8 hover:bg-indigo-600 rounded">編集する</Link> : <></>}
                                            </div>
                                        </div>
                                    </div>
                                </div>
